...
namespace Ambev.DeveloperEvaluation.WebApi.Features.Products
{
    ...
    public class ProductsController : BaseController
    {
        ...
        [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status400BadRequest)]
        [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status404NotFound)]
        public async Task<IActionResult> UpdateStock([FromRoute] int id, [FromBody] UpdateStockRequest request, CancellationToken cancellationToken)
        {
        ...
        public async Task<IActionResult> AddRating([FromRoute] int id, [FromBody] AddRatingRequest request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                // Get updated product to get new rating info
